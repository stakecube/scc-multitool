...
ticker=SCC
coindir=scc
binaries='https://github.com/stakecube/StakeCubeCoin/releases/download/v3.0.0/scc-3.0.0-linux-daemon.zip'
snapshot='https://github.com/stakecube/StakeCubeCoin/releases/download/v3.0.0/bootstrap.zip'
port=40000
rpcport=39999
