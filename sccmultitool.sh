...
binaries='https://github.com/stakecube/StakeCubeCoin/releases/download/v${version}/multitool-binaries.zip'
snapshot='https://github.com/stakecube/StakeCubeCoin/releases/download/v${version}/bootstrap.zip'
port=40000
rpcport=39999
...
#Tools
    ...
    $alias addnode 62.171.177.211 add
    $alias addnode 5.189.159.94 add
    $alias addnode 209.126.3.129 add
    $alias addnode 209.126.3.152 add
    $alias addnode 79.143.186.234 add
    echo "done..."
    exit
    ;;
    99) echo ${version}
